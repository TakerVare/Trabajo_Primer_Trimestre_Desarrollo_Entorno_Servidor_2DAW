...
namespace RestauranteAPI.Repositories
{
    public class BebidaRepository : IBebidaRepository
    {
        ...
        public async Task<List<Bebida>> GetAllAsync(QueryParamsFiltters? nombreProducto)
        {
